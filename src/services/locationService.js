...
export const deriveBetweenTripGpsState = (location) => {
  const speed = Number(location?.speed)
  return Number.isFinite(speed) && speed > MOVEMENT_SPEED_KMH ? 'BETWEEN_TRIPS_MOVING' : 'BETWEEN_TRIPS_STATIONARY'
}
...
export const LocationService = {
  ...
  stopActiveShiftSnapshots() { if (timer !== null && typeof window !== 'undefined') window.clearTimeout(timer); timer = null; activeHandler = null; ActivityDetectionService.stop(); void stopAndroidForegroundService() },
