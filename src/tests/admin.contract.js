...
assert.deepEqual(ADMIN_FORM_KEYS,['vehicle','driver','compliance','maintenance','driverCollectedData','loan','loanPayment','prepayment','driverTarget','breakEvenInputs'])
...
assert.equal(validateAdminForm(loanPayment,{loanId:'l1',paidOn:'2026-09-01',amount:100,principalComponent:80,interestComponent:30,status:'Paid'}).valid,false)
