...
const PRIMARY_DESTINATIONS=['Work','Performance','Timeline','More'];
...
async function loadWorkHeader(){try{const model=await application.getWorkScreenState();workHeader.value={shiftActive:model.shift.active,startedAt:model.shift.startedAt};}catch{workHeader.value={shiftActive:false,startedAt:null};}}
...
function handleBack(){router.handleBack();}function handleWorkStateChanged(){void loadWorkHeader();void loadPerformance();}
