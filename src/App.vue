...
const MORE_GROUPS=[{title:'Vehicle',items:['Vehicle']},{title:'Money',items:['Fuel','Expenses','Revenue','Loans']},{title:'Vehicle Operations',items:['Maintenance','Compliance']},{title:'Business',items:['Dashboard','Profitability']},{title:'Data setup',items:['Historical Entries']},{title:'System',items:['Settings']}];
