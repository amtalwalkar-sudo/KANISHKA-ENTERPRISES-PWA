...
<template>
  <div v-if="props.ocrReviewOpen" class="work-form-overlay ocr-review-overlay" role="dialog" aria-modal="true" aria-labelledby="ocr-review-title">
    <div class="work-form-card ocr-review-card">
      ...
      <button class="secondary-action touch-button-48" type="button" @click="$emit('close-ocr-review')">Back to Close Shift</button>
    </div>
  </div>

  <div v-if="props.endDayConfirm" class="work-form-overlay" role="dialog" aria-modal="true" aria-labelledby="end-day-confirm-title">
    <div class="work-form-card">
      <p class="kfe-eyebrow">END DAY</p>
      <h2 id="end-day-confirm-title">Confirm day closure</h2>
      ...
      <button class="secondary-action touch-button-48" type="button" :disabled="props.busy" @click="$emit('cancel-end-day')">Back to Shift</button>
    </div>
  </div>
</template>
