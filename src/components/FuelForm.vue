...
<template>
  <div class="fuel-form-overlay" role="dialog" aria-modal="true" :aria-label="title">
    <form ref="formRef" class="fuel-form-card" data-kfe-draft-form="true" data-kfe-form-architecture="universal" data-form-type="default" :data-kfe-draft-key="draftKey" @submit.prevent="save">
      ...
      <label data-kfe-field>Odometer *<input v-model="draft.odometer" inputmode="numeric" type="number" min="0" step="1" required></label>
      <label data-kfe-field>Fuel price per litre/kg *<input v-model="draft.pricePerKg" inputmode="decimal" type="number" min="0" step="0.01" required></label>
      <label data-kfe-field>Amount *<input v-model="draft.amount" inputmode="decimal" type="number" min="0" step="0.01" required></label>
