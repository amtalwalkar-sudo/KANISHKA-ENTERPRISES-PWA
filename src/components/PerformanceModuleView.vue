...
<header class="kfe-performance-heading"><div><p class="kfe-eyebrow">READ-ONLY POSITION</p><h1 id="performance-title">Performance</h1><p>Vehicle usage and financial flow, without duplicate calculations or action controls.</p></div><span v-if="performance?.asOf" class="kfe-performance-freshness">Updated {{new Date(performance.asOf).toLocaleTimeString([], {hour:'2-digit',minute:'2-digit'})}}</span></header>
...
<style scoped>
.kfe-performance{padding:4px 0 32px;display:grid;gap:16px}.kfe-performance-heading{display:flex;justify-content:space-between;align-items:flex-start;gap:14px}.kfe-performance-heading h1{margin:0;font-size:clamp(1.7rem,6vw,2.25rem);letter-spacing:-.03em}.kfe-performance-heading p:not(.kfe-eyebrow){margin:5px 0 0;color:var(--kfe-muted-text);line-height:1.4}.kfe-performance-freshness{flex:none;color:var(--kfe-muted-text);font-size:.7rem;padding-top:5px}.kfe-performance-brief,.kfe-performance-why{padding:16px;border:1px solid var(--kfe-ui-border);border-radius:20px;background:var(--kfe-ui-surface);box-shadow:var(--kfe-ui-shadow);display:grid;gap:7px}.kfe-performance-brief strong{font-size:1.15rem;line-height:1.35}.kfe-performance-brief p,.kfe-performance-why p{margin:0;color:var(--kfe-muted-text);line-height:1.45;font-size:.82rem}.kfe-cycle{display:grid;grid-template-columns:repeat(3,1fr);padding:4px;background:var(--kfe-ui-surface-2);border:1px solid var(--kfe-ui-border);border-radius:14px;gap:4px}.kfe-cycle span{text-align:center;padding:9px;border-radius:10px;font-size:.75rem;font-weight:900;color:var(--kfe-muted-text)}.kfe-cycle .is-active{background:var(--kfe-accent-soft);color:var(--kfe-accent)}.kfe-section{display:grid;gap:9px}.kfe-section-title{display:flex;justify-content:space-between;align-items:end}.kfe-section-title h2{margin:2px 0 0;font-size:1.05rem}.kfe-read-only{font-size:.65rem;font-weight:900;color:var(--kfe-muted-text);padding:5px 8px;border:1px solid var(--kfe-ui-border);border-radius:999px}.kfe-vehicle-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:9px}.kfe-performance-card,.kfe-flow-card{padding:15px;border:1px solid var(--kfe-ui-border);border-radius:16px;background:var(--kfe-ui-surface);display:grid;gap:5px}.kfe-performance-card span,.kfe-flow-card span{font-size:.72rem;color:var(--kfe-muted-text);font-weight:800}.kfe-performance-card strong,.kfe-flow-card strong{font-size:1.12rem}.kfe-performance-card small,.kfe-flow-card small{font-size:.66rem;color:var(--kfe-muted-text);line-height:1.35}.kfe-flow{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:9px}.kfe-flow-card:last-child{grid-column:1/-1;border-color:var(--kfe-accent)}.kfe-flow-card:nth-child(2),.kfe-flow-card:nth-child(3),.kfe-flow-card:nth-child(4){background:var(--kfe-ui-surface-2)}.kfe-flow-note{margin:0;color:var(--kfe-muted-text);font-size:.72rem;line-height:1.4}@media(max-width:560px){.kfe-performance-heading{display:block}.kfe-performance-freshness{display:block;margin-top:7px}}@media(max-width:360px){.kfe-vehicle-grid{grid-template-columns:1fr}.kfe-flow{grid-template-columns:1fr}.kfe-flow-card:last-child{grid-column:auto}}
</style>
