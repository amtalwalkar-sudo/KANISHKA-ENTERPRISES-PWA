...
function bind(root){if(root.dataset.kfeDraftBound==='true')return;root.dataset.kfeDraftBound='true';restore(root);root.addEventListener('input',()=>schedule(root));root.addEventListener('change',()=>schedule(root));}
