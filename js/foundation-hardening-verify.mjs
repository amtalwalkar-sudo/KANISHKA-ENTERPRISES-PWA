...
const required=[
  'js/core/record.js','js/core/effective-date.js','js/core/referential-integrity.js','js/core/idempotency.js',
  'js/core/audit.js','js/core/backup.js','js/core/restore.js','js/core/dependency-graph.js','js/core/calculation-version.js',
  'js/core/data-confidence.js','js/core/transaction.js','js/core/idb-v3-contract.js','js/core/contracts.js'
];
const read=p=>fs.readFileSync(p,'utf8');
const checks=[
 ['authoritative record contract',read('js/core/record.js').includes('id')&&read('js/core/record.js').includes('user_id')&&read('js/core/record.js').includes('created_at')&&read('js/core/record.js').includes('updated_at')&&read('js/core/record.js').includes('synced')&&read('js/core/record.js').includes('is_deleted')],
 ...
 ['hardened store contract',read('js/core/idb-v3-contract.js').includes('idempotency')&&read('js/core/idb-v3-contract.js').includes('audit')],
