...
assert.match(store, /recordMissedTrip/); assert.match(store, /LocationService\.startActiveShiftSnapshots/); assert.match(store, /entityType:'SHIFT'/); assert.match(store, /getForEntity\(id\)/)
assert.match(store, /captureShiftEndLocation/); assert.match(store, /MovementAccountingService\.reconcileShiftMovement/); assert.match(store, /movementReconciliationStatus:reconciliation\.reconciliationStatus/)
assert.match(work, /End Shift & Reconcile/); assert.match(work, /Save Reconciliation & End Shift/); assert.match(work, /Shift Reconciliation Complete/); assert.match(work, /pendingGarageLocation/)
