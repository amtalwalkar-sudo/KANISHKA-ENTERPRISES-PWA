...
assert.throws(()=>repo.update({...created,id:'not-a-uuid'},{registration:'invalid'}),/id must be a UUID/);
assert.throws(()=>repo.update({...created,updated_at:'2026-01-01'},{registration:'invalid'}),/updated_at must be an ISO\/UTC timestamp/);
