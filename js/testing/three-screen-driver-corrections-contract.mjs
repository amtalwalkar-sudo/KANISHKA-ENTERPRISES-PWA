...
const performanceImplementation=await readFile('js/application/read-model-composition.js','utf8');
...
const authoritativeForm=await readFile('src/components/AuthoritativeRecordFormRole.vue','utf8');
...
assert.match(performanceImplementation,/const runningCostPaise=/);
assert.match(performanceImplementation,/const balancePaise=/);
assert.match(performanceImplementation,/const runningCostPerKmPaise=/);
assert.match(performanceImplementation,/businessMaintenance/);
assert.doesNotMatch(performanceImplementation,/window|document|localStorage|sessionStorage|indexedDB/);
assert.doesNotMatch(performance,/window|document|localStorage|sessionStorage|indexedDB/);
