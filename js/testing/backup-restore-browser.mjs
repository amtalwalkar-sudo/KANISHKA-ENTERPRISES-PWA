...
try{
  ...
  console.log('PASS: local complete recovery, mutation-triggered refresh, encrypted portable migration, safe restore, integrity rejection, and provider-independent package behavior.');
}finally{
