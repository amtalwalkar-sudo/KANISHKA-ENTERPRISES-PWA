...
for(const id of ['profitability','dashboard']){const c=applicationContractByModuleId(id);assert.equal(c.module.commands.length,0);assert.deepEqual(c.module.queries,['GET']);}
