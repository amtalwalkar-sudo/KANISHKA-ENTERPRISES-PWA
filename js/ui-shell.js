...
function publish(){
  ...
  window.__KFE_RUNTIME__=Object.freeze({workViewModel:models.work,fuelViewModel:models.fuel,expensesViewModel:models.expenses,revenueViewModel:models.revenue,maintenanceViewModel:models.maintenance,loanViewModel:models.loan,renewalsViewModel:models.renewals,dashboardViewModel:dashboardSnapshot,actions:mergedActions});
