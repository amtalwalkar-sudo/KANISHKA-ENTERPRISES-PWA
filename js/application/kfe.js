...
export function createKfeApplication(repository){
 ...
 return Object.freeze({graph,startWork,getWork,listWork,completeWork,listFuel,recordFuel,updateFuel,undoFuel,listTrips,recordTrip,updateTrip,undoTrip,recordRevenue,getStatus,getTimeline,resetAllData,calculateWorkSession,expectedTomorrowKm,rollingFuelCostPerKm,projectedFuelCostForKm,businessExpenses,fixedExpensePerBusinessKm,provisionMaintenance,reconcileInvoice,maintenanceAlerts,businessRevenue,amortize,applyPrepayment,profitability,tomorrowTarget,evaluateAlerts});
}
