...
export function businessDateFromShiftStart(startAt){if(typeof startAt!=='string')return null;const t=Date.parse(startAt);if(!Number.isFinite(t))return null;return new Date(t).toISOString().slice(0,10);}
