...
export function paise(value){if(!Number.isInteger(value))throw new TypeError('Currency must be integer paise');return value;}
...
export function roundInt(value){return Math.round(value);}
